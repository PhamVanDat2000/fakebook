	...
	return (
		<div className='registerForm'>
			...
			<div className="dayOfBirth">
				<select className="dayOption" name="date_of_birth:day" tabindex="7">
					<option value="">
					</option>
				...
				<select className="monthOption" name="date_of_birth:mon" tabindex="8">
					<option value="">
					</option>
			...
			<label htmlFor="">Gender:<br /></label>
			<div className="genderField">

				<label htmlFor="male" className="radioInputGender">Male
					<input type="radio" name="gender" id='male' />
				</label>

				<label htmlFor="female" className="radioInputGender">Female
					<input type="radio" name="gender" id='female' />
				</label>

				<label htmlFor="custome" className="radioInputGender">Custome
